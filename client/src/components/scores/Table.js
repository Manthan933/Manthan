...
const headCells = [
  ...
  { id: 'email', numeric: false, label: 'Student Email' },
  { id: 'marks', numeric: true, label: 'Marks Obtained' },
  { id: 'max_marks', numeric: true, label: 'Maximum Marks' },
  { id: 'percentage', numeric: true, label: 'Percentage Marks' }
];
...
export default function EnhancedTable({ scores }) {
          ...
          >
            ...
            <TableBody>
              {stableSort(scores, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  return (
                    <TableRow hover tabIndex={-1} key={row.name} id={index}>
